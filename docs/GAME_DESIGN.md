...
| 하수구 쥐 | 35 | 물리 11+파일 1장 버리기 / 방어 10+버리기 / 물리 11+힘 3+파일 1장 버리기 |
| 쥐 3마리 | 각 10 | 각자 물리 피해 6 반복 |
| 초록 슬라임 | 40 | 물리 피해 8 또는 물리 피해 8+다음 공격 마법화 |
...
`흑요석 단검`은 특별 카드 배열 안에 정의되어 있지만 등급 표시는 희귀다. 따라서 문서에서 배열 위치와 화면 등급을 혼동하지 않는다.
...
| 심안 | 20회 이동 동안 시야를 9×9로 확대 |
| 폭탄 | 지도 칸에 설치, 3회 이동 뒤 3×3 범위 적에게 피해 20. 바위는 세 번 맞으면 파괴 |
| 복제 | 카드 또는 티켓 하나를 복제. 전설 카드는 복제 불가 |
...
안전 지대 축복 노드는 아직 얻지 않은 축복 3개를 보여 준다. 재추첨 비용은 50골드에서 시작해 한 번마다 10골드씩 오른다.
...
| 탐욕 | 획득 골드 2배 |
| 가방 | 인벤토리 +12, 덱 슬롯 +1 |
| 운동선수 | 수동으로 켜고 끄는 30턴마다 1회 무료 이동 |
